...
var operators_ = __webpack_require__(2);
...
// CONCATENATED MODULE: ./.tmp/chronos/i18n/sk.ts
// tslint:disable:comment-format binary-expression-operand-order max-line-length
// tslint:disable:no-bitwise prefer-template cyclomatic-complexity
// tslint:disable:no-shadowed-variable switch-default prefer-const
// tslint:disable:one-variable-per-declaration newline-before-return
...
var sk_months = 'január_február_marec_apríl_máj_jún_júl_august_september_október_november_december'.split('_');
var sk_monthsShort = 'jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec'.split('_');
function sk_plural(num) {
    return (num > 1) && (num < 5) && (~~(num / 10) !== 1);
}
function sk_translate(num, withoutSuffix, key, isFuture) {
    var result = num + ' ';
    switch (key) {
        case 's':// a few seconds / in a few seconds / a few seconds ago
        ...
        case 'ss':// 9 seconds / in 9 seconds / 9 seconds ago
            if (withoutSuffix || isFuture) {
                return result + (sk_plural(num) ? 'sekundy' : 'sekúnd');
            }
            else {
                return result + 'sekundami';
            }
        ...
        case 'mm':// 9 minutes / in 9 minutes / 9 minutes ago
            if (withoutSuffix || isFuture) {
                return result + (sk_plural(num) ? 'minúty' : 'minút');
            }
            else {
        ...
        case 'hh':// 9 hours / in 9 hours / 9 hours ago
            if (withoutSuffix || isFuture) {
                return result + (sk_plural(num) ? 'hodiny' : 'hodín');
            }
            else {
                return result + 'hodinami';
            }
        ...
        case 'dd':// 9 days / in 9 days / 9 days ago
            if (withoutSuffix || isFuture) {
                return result + (sk_plural(num) ? 'dni' : 'dní');
            }
            else {
                return result + 'dňami';
            }
        ...
        case 'MM':// 9 months / in 9 months / 9 months ago
            if (withoutSuffix || isFuture) {
                return result + (sk_plural(num) ? 'mesiace' : 'mesiacov');
            }
            else {
        ...
        case 'yy':// 9 years / in 9 years / 9 years ago
            if (withoutSuffix || isFuture) {
                return result + (sk_plural(num) ? 'roky' : 'rokov');
            }
            else {
                return result + 'rokmi';
            }
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "skLocale", function() { return skLocale; });
